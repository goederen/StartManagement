		...
		<div class="section-overlay-layer">
			<div class="container">
				<div class="contact-section-header">
					<h2 class="dark-text">Contact</h2><div class="colored-line"></div>
					<div class="sub-heading">Laat uw reactie achter via het onderstaande contactformulier, ik zorg er voor dat u zo snel mogelijk antwoord ontvangt.</div>
				</div>			
