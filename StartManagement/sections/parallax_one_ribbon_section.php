...
$parallax_one_ribbon_text = get_theme_mod('parallax_one_ribbon_text',esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.','parallax-one'));
...
if( !empty($parallax_one_button_link) && strpos($parallax_one_button_link, '#') === 0 && 1==2) {
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					if( !empty($parallax_one_ribbon_text) ){
						echo '<h3 class="white-text">'.$parallax_one_ribbon_text.'</h3>';
					} elseif ( is_customize_preview() ) {
