...
global $wp_customize;
$teller = 1;
$parallax_one_our_services_title = get_theme_mod( 'parallax_one_our_stappen_title', esc_html__( 'Our Services', 'parallax-one' ) );
$parallax_one_our_services_subtitle = get_theme_mod( 'parallax_one_our_stappen_subtitle', esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'parallax-one' ) );
$parallax_one_services = get_theme_mod('parallax_one_stappen_content', json_encode( array(
			...
			<div class="container">
				...
				<div class="section-header">
					...
					if( !empty( $parallax_one_our_services_subtitle ) ){ ?>
						<div class="sub-heading"><?php echo $parallax_one_our_services_subtitle; ?></div>
					<?php
					} elseif ( isset( $wp_customize ) ) { ?>
					...
					<div id="our_services_wrap" class="services-wrap <?php if( !empty($parallax_one_services_pinterest) ) echo 'our_services_wrap_piterest'; ?>"> 
						...
						foreach( $parallax_one_services_decoded as $parallax_one_service_box ){
							...
							if( function_exists( 'pll__' ) ){
								...
								$subtitle = pll__( $parallax_one_service_box->subtitle );
								...
								$subtitle = apply_filters( 'wpml_translate_single_string', $parallax_one_service_box->subtitle , 'Parallax One -> Services section', 'Service box title '.$parallax_one_service_box->id );
...
<div class="service-box-custom-wrapper">	<!-- peter -->							
									<?php
										...
										if( !empty( $choice ) && $choice !== 'parallax_none' ){
											...
											if( $choice == 'parallax_icon' ){
												if( !empty( $icon ) ) {
													...
													<div class="service-icon colored-text">
													<i class="material-icons" style="font-size:60px;">looks_<?
													if ($teller==1) {
														echo("one");
												    }
													else {
													...
													$teller++;
													?></i>
<!--															<span class="<x?php echo esc_attr( $icon ); ?>"></span> -->
														</div>
													<?php
													}
												}
		...
		<? //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@		?>					
										<div class="service-details">
											<div class="member-details-inner">
												<h3 class="white-text strong"> <?echo str_replace('*','<br/><br/>',$subtitle);?></h5>
