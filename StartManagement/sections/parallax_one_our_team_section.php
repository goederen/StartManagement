				...
				if( !empty($parallax_one_our_team_title) || !empty($parallax_one_our_team_subtitle)){ ?>
					<div class="section-header">
						...
						if( !empty($parallax_one_our_team_title) ){ ?>
							<h2 class="dark-text"><?php echo $parallax_one_our_team_title ; ?></h2><div class="colored-line"></div>
						<?php
						...
						if( !empty($parallax_one_our_team_subtitle) ){ ?>
							<div class="sub-heading" style="text-align:left;"><?php echo $parallax_one_our_team_subtitle; ?></div>
						<?php		
						} elseif ( isset( $wp_customize ) ) { ?>
