						...
						<?php
							if( !empty($paralax_one_our_story_image) ){
								if( !empty($parallax_one_our_story_title) ){
									echo '<div class="col-md-4 brief-content-two"><div class="brief-image-right"><img src="'.parallax_one_make_protocol_relative_url(esc_url($paralax_one_our_story_image)).'" alt="'
									.esc_attr($parallax_one_our_story_title).'"><center><small><i><p style="line-height:20px;">Léon Hoogeveen, eigenaar StartManagement en ervaringsdeskundige!</p></i></small></center></div></div>';
								} else {
									echo '<div class="col-md-4 brief-content-two"><div class="brief-image-right"><img src="'.parallax_one_make_protocol_relative_url(esc_url($paralax_one_our_story_image)).'" alt="'
									.esc_html__('About','parallax-one').'"><center><small><i><p style="line-height:20px;">Léon Hoogeveen, eigenaar StartManagement en ervaringsdeskundige!</p></i></small></center></div></div>';
								}
...
?>
			...
			<section class="brief text-left brief-design-one brief-left paralax_one_only_customizer" id="story" role="region" aria-label="<?php esc_html_e('About','parallax-one') ?>">
				<?php parallax_hook_about_top(); ?>
				<div class="col-md-8 brief-content-two paralax_one_only_customizer"><img src="" alt=""><div class="brief-image-right"></div></div>
				<div class="col-md-8 content-section brief-content-one">
